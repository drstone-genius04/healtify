...
def display_home():
    ...
    grey = (173, 173, 166)
    green  = (107,200,176)
    font = pg.font.Font("C:/Users/allan/Desktop/pythonproject/Digitalth/Raleway-Medium.ttf", 30)
    clock = pg.time.Clock()
    ...
    while not done:
        ...
        #         done = True
        largeText = pg.font.Font("C:/Users/allan/Desktop/pythonproject/Digitalth/Raleway-Medium.ttf", 80)
        TextSurf, TextRect = text_objects("Welcome to Digitalth!", largeText)
        ...
        font1 = pg.font.Font("C:/Users/allan/Desktop/pythonproject/Digitalth/Raleway-Medium.ttf",30)
